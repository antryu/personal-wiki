<!-- GitHub Trending: Go | 538 stars | +37 today -->
...
- **Created**: 2025-07-28
- **Updated**: 2026-05-04
- **Topics**: aerc, agents, ai, autonomous-agents, awesome, bubbletea, cli, email, email-cli, email-client, email-sender, go, hacktoberfest, inbox, matcha, mutt, opensource, pine, tui
- **Open Issues**: 516
...
**[Report Bug](https://github.com/floatpane/matcha/issues/new?template=bug_report.md)** · **[Request Feature](https://github.com/floatpane/matcha/issues/new?template=feature_request.md)** · **[Con