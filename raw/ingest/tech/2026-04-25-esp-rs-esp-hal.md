<!-- GitHub Trending: Rust | 1,862 stars | +5 today -->
...
- **Created**: 2021-11-18
- **Updated**: 2026-04-25
- **Topics**: embedded, embedded-hal, esp32, rust
- **Open Issues**: 289
...
If you are a user of `unstable` APIs, we will never push breaking changes in a patch release. However, `unstable` changes _will_ make their way into minor releases. This means that as an `unstable` user updating from `1.1.x` to `1.2.x` _may_ introduce breaking 