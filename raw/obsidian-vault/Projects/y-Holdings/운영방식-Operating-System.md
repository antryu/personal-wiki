...
- **사업부**: _y Capital, _y SaaS

### 에이전트 배치 (10층 타워)
| 층 | 부서 | 에이전트 |
|---|---|---|
| 10F | 회장실 | Andrew (유일한 인간) |
...
| 2F | _y Capital | #23 Quanty, #24 Tradey, #25 Globy, #26 Fieldy, #27 Hedgy, #28 Valuey |
...
### 보고 라인
```
에이전트 → 부서 회의 → 본부장 → 기획조정실 → 회장
```

### 보고 유형
- **일상 보고**: 부서 내 자체 처리, 결과만 기록
- **주간 보고**: 각 본부 → 기획조정실(Tasky) → 회장
- **긴급 보고**: 해당 부서 → 직접 회장 (리스크/보안/재무 이슈)
- **크로스 부서**: 관련 부서 합동 회의 → 합의안 → 회장 결재
